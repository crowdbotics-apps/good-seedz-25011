"""good_seedz_25011 URL Configuration
...
admin.site.site_header = "Good Seedz"
admin.site.site_title = "Good Seedz Admin Portal"
admin.site.index_title = "Good Seedz Admin"

# swagger
api_info = openapi.Info(
    title="Good Seedz API",
    default_version="v1",
    description="API documentation for Good Seedz App",
)
